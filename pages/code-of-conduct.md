...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by writing to [{{ settings.email }}](mailto:{{ settings.email }}). All complaints will be reviewed and investigated promptly and fairly.
